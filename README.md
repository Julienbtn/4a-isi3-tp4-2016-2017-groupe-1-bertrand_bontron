...
On vous fournit trois classes dont un programme principal dans la classe **vue.SimpleLogo**.
...
model.Tortue dans ses déplacements (avant, arrière, droite, gauche) avec les boutons de l’IHM
